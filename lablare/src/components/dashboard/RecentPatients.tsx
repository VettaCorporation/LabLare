// Caminho: src/components/dashboard/RecentPatients.tsx (CORRETO, SEM ALTERAÇÕES)
'use client';
                    ...
                    <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                        {patients.map((patient) => (
                            <tr key={patient.id_paciente}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{patient.contato || 'N/A'}</td>
